...
# ---------- 環境設定 ----------
RETRIEVAL_URL = os.getenv("RETRIEVAL_URL", "https://retrieval-agent-966644831682.asia-east1.run.app/mcp")
REPORT_URL    = os.getenv("REPORT_URL", "https://report-agent-966644831682.asia-east1.run.app/mcp")
CSV_PATH      = "sample.csv"
